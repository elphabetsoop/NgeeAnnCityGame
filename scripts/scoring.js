...
export function freeplayUpkeep(gameBoard, profit, upkeep, x, y, building, buildingStats) {
    ...
    if (unconnectedRoads) {
        ...
        buildingStats.i_upkeep += unconnectedRoads;
    }
